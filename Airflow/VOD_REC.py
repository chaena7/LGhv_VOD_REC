...
def week_info_s3(**context):
    ...
    if not file_exists:
        ...
        new_json = {"columns": ["week_info"],"values": [40]}  # 40주차부터 시작(10월1일~)
...
with DAG(
    ...
    schedule_interval='@once'  # 실행 주기 설정, 현재는 한번만 실행
) as dag:
